...
public class TripManagementCancelAdapter extends RecyclerView.Adapter<TripManagementCancelAdapter.ViewHolder> {
    ...
    public TripManagementCancelAdapter(List<Trip> modelCanceledFragments, Context context, Presenter presenter) {
    ...
    @NonNull
    @Override
    public TripManagementCancelAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TripManagementCancelAdapter.ViewHolder holder, int position) {
...
//                txt_alertdialogNameFamilyNewFragment.setText(model.getStrApplicantName());
    ...
    private void openAlertDialog(Trip model) {
        ...
        dialog2.setPositiveButton("بله", (dialog21, which) -> {
            ...
            presenter.confirm_CancelTripAlert(model.getiOfficialTrip());
