...
public class TripConfirmedFragmentAdapter extends RecyclerView.Adapter<TripConfirmedFragmentAdapter.ViewHolder> {

    public List<Trip> modelConfirmedTripTabLayout;
    Context context;
    Presenter presenter;

    public TripConfirmedFragmentAdapter(List<Trip> modelConfirmedTripTabLayout, Context context, Presenter presenter) {
    ...
    @NonNull
    @Override
    public TripConfirmedFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TripConfirmedFragmentAdapter.ViewHolder holder, int position) {
...
//                txt_alertdialogNameFamilyNewFragment.setText(model.getStrApplicantName());
            ...
            txt_cancel.setOnClickListener(v13 -> {
                ...
                dialog2.setPositiveButton("بله", (dialog1, which) ->  presenter.cancelConfirmedTripAlertTabLayoutTripManagement(model.getiOfficialTrip()));
