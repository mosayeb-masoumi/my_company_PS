...
public class Model implements Contract.Model {
    ...
    @Override
    public void requesrListWaitingDriverTabLayout() {
        ...
        call.enqueue(new Callback<List<Trip>>() {
            ...
            public void onResponse(Call<List<Trip>> call, Response<List<Trip>> response) {
                if(response.code()==200){
                    App.waitingDriverConfirmTabLayoutListSuccess=false;

                    App.listWaitingDriverConfirmTabLayout = response.body();
                    if(App.listWaitingDriverConfirmTabLayout != null){
    ...
    @Override
    public void requestCancelDriverConfirmedAlertTabLayoutTripManagement(int iOfficialTrip) {
        Trip trip=new Trip();
        ...
        call.enqueue(new Callback<Integer>() {
            ...
            public void onResponse(Call<Integer> call, Response<Integer> response) {
                if(response.code()==200){
                    presenter.cencelTripAlertResult(response.body());
                }else{
                    presenter.cencelTripAlertResult(-4);
                }
            }

            @Override
            public void onFailure(Call<Integer> call, Throwable t) {
                presenter.cencelTripAlertResult(-5);
            }
        });
    }
