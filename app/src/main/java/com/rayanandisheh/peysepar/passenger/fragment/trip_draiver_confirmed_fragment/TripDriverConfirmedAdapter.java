...
public class TripDriverConfirmedAdapter extends RecyclerView.Adapter<TripDriverConfirmedAdapter.ViewHolder> {

    private List<Trip> modelWaitingDriverFragments;
    private Context context;
    private Presenter presenter;

    public TripDriverConfirmedAdapter(List<Trip> modelWaitingDriverFragments, Context context, Presenter presenter) {
    ...
    @NonNull
    @Override
    public TripDriverConfirmedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TripDriverConfirmedAdapter.ViewHolder holder, int position) {
...
//                txt_alertdialogNameFamilyNewFragment.setText(model.getStrApplicantName());
            ...
            txt_cancel.setOnClickListener(v12 -> {
                ...
                dialog2.setPositiveButton("بله", (dialog1, which) ->  presenter.cancelDriverConfirmedAlertTabLayoutTripManagement(model.getiOfficialTrip()));
