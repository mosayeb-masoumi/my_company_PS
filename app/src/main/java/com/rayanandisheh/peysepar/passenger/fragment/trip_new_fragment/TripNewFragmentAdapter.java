...
public class TripNewFragmentAdapter extends RecyclerView.Adapter<TripNewFragmentAdapter.ViewHolder> {

    public List<Trip> modelTripNewTabLayout;
    Context context;
    Presenter presenter;

    public TripNewFragmentAdapter(List<Trip> modelTripNewTabLayout, Context context, Presenter presenter) {
    ...
    @NonNull
    @Override
    public TripNewFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TripNewFragmentAdapter.ViewHolder holder, int position) {
        ...
        holder.txt_originAddress.setText(model.getStrOriginName());
...
//        holder.txt_applicantPhone.setText(model.getStrApplicantMobile());
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            txt_confirm.setOnClickListener(v14 -> {
                presenter.confirmNewAlertTabLayoutTripManagement(model.getiOfficialTrip());
                dialog.dismiss();
            });
            ...
            txt_cancel.setOnClickListener(v12 -> {
                ...
                dialog2.setPositiveButton("بله", (dialog1, which) -> presenter.cancelNewAlertTabLayoutTripManagement(model.getiOfficialTrip()));
