...
public class TripRunningFragmentAdapter extends RecyclerView.Adapter<TripRunningFragmentAdapter.ViewHolder> {

    private List<Trip> modelRunningFragments;
    Context context;
    Presenter presenter;

    public TripRunningFragmentAdapter(List<Trip> modelRunningFragments, Context context, Presenter presenter) {
    ...
    @NonNull
    @Override
    public TripRunningFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int typeView) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TripRunningFragmentAdapter.ViewHolder holder, int position) {
